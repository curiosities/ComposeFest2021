...
fun TodoScreen(
    ...
    Column {
        ...
        //  LazyColumn will recompose all of the children on the screen.
        LazyColumn(
...
fun TodoRow(
    ...
    // to remember the tint that we used in the last composition.
    // Compose lets us store values in the composition tree,
    // so we can update TodoRow to store the iconAlpha in the composition tree.
